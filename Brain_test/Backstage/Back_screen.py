...
class Login():
    ...
    def  user_addcourse(self,driver,courseName):
         ...
         driver.find_element_by_xpath(".//*[@id='courseType']/label[2]/i").click()
    ...
    def  user_microclassmanagement(self,driver,microName):
         ...
         sleep(2)
    #课程管理-案例管理
    def  user_casemanagement(self,driver,caseName,txtCaseDesc,body,num,textarea,biaotinum,input,xuanxiang,txtDiscussQues,txtDiagnoseQues,body1):
         sleep(2)
         driver.find_element_by_xpath(".//*[@class='m-leftBar']/a[1]").click()
         sleep(8)
         driver.find_element_by_xpath(".//*[@class='u-button u-small f-corg']").click()
...
class TeachLogin():
    def user_login(self,driver,txtUsername,txtPassword):
        ...
        driver.find_element_by_xpath(".//*[@id='loginform']/div[2]/div/ul/li[2]/p").click()
        sleep(4)
