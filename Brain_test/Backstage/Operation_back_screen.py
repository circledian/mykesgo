#-*- coding:utf-8 -*-
from Brain_test.Backstage.Back_screen import *
...
def backstage(base_url,tecphonenum,exname):
 ...
 # 课程管理-案例管理
 login.user_casemanagement(driver,Unicode(3),Unicode(3),Unicode(3),1,Unicode(3),1,Unicode(3),Unicode(3),Unicode(3),Unicode(3),Unicode(3))

 # 添加班级学生
 Add_Student(base_url).add_edit_stu(tecphonenum,Unicode(3))
